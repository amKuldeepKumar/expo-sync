...
export const HELP_DRAWER_TIPS = {
  ...
  "/tasks": [
    "View all task in the data grid, with status, vendor and assignee",
    "Click on a task to view their detailed information.",
    "you can create new task and modify the task or remove the task",
    "This section helps you organize and manage your tasks.",
  ],
  "/client-details": [
    "You are viewing details for the selected client.",
    "You can add new employees for the client using the provided forms.",
    ...
    "Click on an event to view its detailed page with full information about the event.",
  ...
  "/event-details": [
    ...
    "Review the event details, including date, location, and agenda.",
    "Through the 'Assign Event' section, you can assign participants to the event.",
    "You can select clients for this event using the 'Add Client'.",
    "Use the 'Add Task' to add specific tasks related to the event.",
  ...
  "/task-details": [
    ...
    "Once the comment is added, it will be displayed in the Task Comments table below.",
    "In the Task Comments table, you can edit or delete any comment for better task tracking.",
  ],
  "/vendor-details": [
    "You are viewing the details for the selected vendor.",
    "Review the vendor's basic information such as products, services, and agreements.",
    "Toggle the 'Add Employee' button to open the employee creation form.",
    "In the 'Add Employee' section, you can add employees associated with the vendor.",
    "The 'Vendor Employee List' table below shows all employees assigned to the vendor.",
    "You can edit or delete any employee from the list.",
    "The 'Task Allocated List' table displays all tasks allocated to the vendor.",
    "Click on any task in the 'Task Allocated List' to view more details and manage it.",
    "You can edit or delete tasks from the allocated task list.",
    "Clicking on a task will redirect you to the Task Details page for further actions.",
  ],
  "/team-details": [
    "You are viewing the details for the selected team.",
    "In the Add Team Member section, you can assign roles such as Manager, Team Lead, or Executor to the team member.",
