...
export const HELP_DRAWER_TIPS = {
  ...
  "/events": [
    ...
    "To add a new event, click on the 'Add Event' toggle button, which opens a form to add the event details.",
  ...
  "/tasks": [
    ...
    "To add a new task, click on the 'Add Task' toggle button, which opens a form to input the task details.",
